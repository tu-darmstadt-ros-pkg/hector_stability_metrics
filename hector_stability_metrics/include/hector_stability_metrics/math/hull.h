...
inline bool
isClockwiseTurn( const MatrixBase1 &o, const MatrixBase2 &a, const MatrixBase3 &b,
                 typename MatrixBase1::value_type threshold = typename MatrixBase1::value_type( 0.0 ) )
{
  // It's a counter clockwise turn if (ax - ox) * (by - oy) - (ay - oy) * (bx - ox) is greater than 0
